                ...
                <div class="row align-items-center text-center text-sm-start">
                    <div class="col-lg-6">
                        <div class="mb-lg-0 mb-5">
                            <h1 class="hero-title">
                                The best way to <span class="highlight highlight-success d-inline-block">showcase</span>
                                your saas
                            </h1>
                            ...
                            <div class="d-flex mt-1 fs-12">
                                <div class="me-4">
                                    <i data-feather="check" class="icon icon-dual-success icon-xs me-1"></i>Free 14-day
                                    Demo
                                </div>
                                <div>
                                    <i data-feather="check" class="icon icon-dual-success icon-xs me-1"></i>No credit
                                    card needed
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="img-content position-relative">
                        <div class="img-up mb-lg-0 mb-6">
                            <img src="/images/hero/saas1.jpg" alt="app img" class="img-fluid d-block rounded"
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-auto">
                    <a href="#" class="btn btn-primary mb-2">
                        Sign Up Now <i class="icon-xs ms-2" data-feather="arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
